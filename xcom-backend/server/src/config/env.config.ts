...
export const ELASTIC_SEARCH_URL: string = process.env.ELASTIC_SEARCH_URL || 'localhost:9200'
export const FCM_SERVER_KEY: string = process.env.FCM_SERVER_KEY!
export const APP_NAME = process.env.APP_NAME!
export const APP_VERSION_CODE = process.env.APP_VERSION_CODE!
export const APP_VERSION_NAME = process.env.APP_VERSION_NAME!
